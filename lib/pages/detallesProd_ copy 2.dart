...
class DetallesProdPage3 extends StatefulWidget {
  @override
  _DetallesProdPage3State createState() => _DetallesProdPage3State();
}

class _DetallesProdPage3State extends State<DetallesProdPage3> {
  int cantidad = 1;
  bool star1 = false;
  bool star2 = false;
  bool star3 = false;
                    ...
                    child: Row(
                      ...
                      children: [
                        Flexible(
                            flex: 1,
                            child: Container(
                                child: Image.asset('assets/49_Taco_de_Bistec_de_Puerco.png',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                                'Ricos tacos de bistec, marinados.',
                                textAlign: TextAlign.center,
                                style: GoogleFonts.montserrat(
                                    color: Colors.black,
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () async {
                          await launch(
                            'https://ra-gif.web.app/26-alitas.html',
                            forceSafariVC: false,
                            forceWebView: false,
